package io.github.sustainable.marketplace.config;


import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.HikariDataSource;
import io.github.sustainable.marketplace.properties.DbProperties;
...
@EnableJpaRepositories(
        basePackages = "io.github.sustainable.marketplace.repository",
...
public class PgSqlDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerPgSql() {
        ...
        em.setPackagesToScan("io.github.sustainable.marketplace.entity");
